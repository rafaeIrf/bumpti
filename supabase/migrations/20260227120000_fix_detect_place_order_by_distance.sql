-- =============================================================================
-- Migration: Fix detect-place to order candidates by distance (nearest first)
-- =============================================================================
-- Problem: get_current_place_candidate orders by relevance_score DESC,
--   which returns the most "relevant" place instead of the nearest one.
--   Fix: Order by distance ASC so the closest candidate is returned.
-- =============================================================================
...
BEGIN
  ...
  -- Return the nearest candidate place with full information
...
'Returns complete place information for detected location. Orders by distance (nearest first) instead of relevance_score. Uses get_combined_place_avatars to show both active users and regulars. Checks for active presence and filters by active categories.';
