-- =============================================================================
-- Migration: Adjust Nearby Activity Heating Threshold
-- =============================================================================
-- Based on: 99999999999999_replicate_prod_schema.sql (lines 1362-1482)
-- Changes:
-- 1. Reduce nearby_activity_heating threshold from >= 5 to >= 3 active users
-- =============================================================================
...
begin
  ...
  -- 3. NEARBY HEATING (Max 1 per user, Count >= 3, Dist < 20km)
  select
    sub.target_user_id,
...
'Returns candidates for place activity notifications with threshold of >= 3 users for nearby heating';
