-- =============================================================================
-- Migration: Fix get_suggested_plans eligibility filtering
-- =============================================================================
-- Uses get_eligible_active_users_count helper to filter plans by eligibility.
...
Uses get_eligible_active_users_count to apply 8-filter eligibility matrix.
