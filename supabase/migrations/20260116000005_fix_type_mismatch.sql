-- ============================================================================
-- FIX: Type mismatch in text_rank (numeric vs double precision)
-- ============================================================================
...
BEGIN
  ...
  WITH ranked_places AS (
    SELECT
      ...
      -- FIX: Cast to double precision to match return type
      (
        CASE
        ...
        END
        +
        (LEAST(p.total_score::double precision / 100.0, 1.0) * 10.0)  -- CAST HERE
      )::double precision as text_rank  -- AND HERE
