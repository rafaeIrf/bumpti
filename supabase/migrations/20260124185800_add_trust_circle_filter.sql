...
-- 1. Bidirectional age filter (from 20260121020500)
-- 2. Trust Circle filter (filter_only_verified bidirectional check)
-- 3. Correct LATERAL JOINs for intentions/photos
-- 4. entry_type in return
-- =============================================================================
...
Includes entry_type (physical/checkin_plus) and properly aggregated intentions/photos.';
