-- Add review aggregation to search_places_by_favorites and search_places_autocomplete

-- 1. Drop and recreate search_places_by_favorites with review fields
...
-- 2. Drop and recreate search_places_autocomplete with review fields and active_users
